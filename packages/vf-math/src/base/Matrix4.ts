...
class Matrix4 extends AbstractMathObject<number[]> {
	...
	makeBasis(xAxis: Vector3Like, yAxis: Vector3Like, zAxis: Vector3Like): this {
		this.set(
	...
	makeRotationAxis(axis: Vector3Like, angle: number): this {
	...
	makePerspective(left: number, right: number, top: number, bottom: number, near: number, far: number, isWebGLCoordinateSystem = true, reversedDepth = false): this {
		const te = this.elements;
	...
	makeOrthographic(left: number, right: number, top: number, bottom: number, near: number, far: number, isWebGLCoordinateSystem = true, reversedDepth = false): this {
		const te = this.elements;
	...
	equals(matrix: Matrix4, eps = Tolerance.LENGTH_EPS): boolean {
		const te = this.elements;
